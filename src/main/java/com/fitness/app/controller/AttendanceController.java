...
public class AttendanceController {
	...
	@ApiResponses(value = { @ApiResponse(code=200, message = "Performance of the user", response = ResponseEntity.class),
	@ApiResponse(code = 404, message ="Not Found", response=NotFoundException.class), @ApiResponse(code = 403, message ="Forbidden", response=ForbiddenException.class),
	@ApiResponse(code = 401, message ="Unauthorized", response=AuthenticationException.class)})
	...
	public ResponseEntity<Object> userPerformance(@Email @RequestParam String email, @NotNull @NotBlank @RequestParam String gym) throws DataNotFoundException
	{
