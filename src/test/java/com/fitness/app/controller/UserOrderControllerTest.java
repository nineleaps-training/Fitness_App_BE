...
class UserOrderControllerTest {
        ...
        void testAllMyUsers() throws Exception {
                ...
                list.add(4);
                UserPerformanceModel userPerformanceModel = new UserPerformanceModel("Pankaj Jain",
                                "pankaj.jain@nineleaps.com",
                                "GM6", "vendor", list, 3.5);
                Set<UserPerformanceModel> set = new HashSet<>();
                set.add(userPerformanceModel);
                Mockito.when(userOrderService.allMyUser(userPerformanceModel.getGym())).thenReturn(set);
        ...
        void testBookedGym() throws Exception {
                ...
                Mockito.when(userOrderService.bookedGym(gymRepresent.getEmail())).thenReturn(list);
                mockMvc.perform(MockMvcRequestBuilders
        ...
        void testCheckUserCanOrder() throws Exception {
                ...
                UserOrder userOrder = new UserOrder("GM6", "email", "gym", services, "subscription", "slot", 1234,
                                "booked",
        ...
        void testOrderNow() throws Exception {
                ...
                List<String> services = new ArrayList<>();
                services.add("zumba");
                UserOrder userOrder = new UserOrder("GM6", "pankaj.jain@nineleaps.com", "gym", services, "subscription",
                                "slot",
                ...
                mockMvc.perform(MockMvcRequestBuilders
                                .post("/v1/userOrder/order/now").contentType(MediaType.APPLICATION_JSON)
                                .content(content))
        ...
        void testPendingOrderList() throws Exception {
        ...
        void testUpdatingOrder() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders
                                .put("/v1/userOrder/update/order").contentType(MediaType.APPLICATION_JSON)
                                .content(content))
