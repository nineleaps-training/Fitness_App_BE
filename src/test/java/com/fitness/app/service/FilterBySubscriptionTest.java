...
class FilterBySubscriptionTest {
    ...
    void testFilterByHalfYearly() {
        ...
        List<GymClassModel> list2 = filterBySubscription.filterByHalfYearly(gymClassModel.getMSubscription().getHalf(),list);
    ...
    void testFilterByMonthly() {
        ...
        List<GymClassModel> list=new ArrayList<>();
        list.add(gymClassModel);
        List<GymClassModel> list2 = filterBySubscription.filterByMonthly(gymClassModel.getMSubscription().getMonthly(),list);
        Assertions.assertEquals(list, list2);
    ...
    void testFilterByOneWorkout() {
        ...
        List<GymClassModel> list=new ArrayList<>();
        list.add(gymClassModel);
        List<GymClassModel> list2 = filterBySubscription.filterByOneWorkout(gymClassModel.getMSubscription().getOneWorkout(),list);
        Assertions.assertEquals(list, list2);
    ...
    void testFilterByQuarterly() {
        ...
        List<GymClassModel> list=new ArrayList<>();
        list.add(gymClassModel);
        List<GymClassModel> list2 = filterBySubscription.filterByQuarterly(gymClassModel.getMSubscription().getQuaterly(),list);
        Assertions.assertEquals(list, list2);
    ...
    void testFilterByYearly() {
        ...
        List<GymClassModel> list=new ArrayList<>();
        list.add(gymClassModel);
        List<GymClassModel> list2 = filterBySubscription.filterByYearly(gymClassModel.getMSubscription().getYearly(),list);
        Assertions.assertEquals(list, list2);
    }
