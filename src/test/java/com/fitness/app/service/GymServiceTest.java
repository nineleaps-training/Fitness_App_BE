...
class GymServiceTest {
        ...
        void testAddNewGym() {
                ...
                gymClassModel = new GymClassModel("pankaj.jain@nineleaps.com", "Fitness", gymAddressClass, workoutList,
                                gymTime,
                                gymSubscriptionClass, l, 20);
                GymClass gymClass = new GymClass("GM1", "pankaj.jain@nineleaps.com", "Fitness", workoutList, l, 3.5,
                                20);
        ...
        void testAddNewGymNull() {
                ...
                gymClassModel = new GymClassModel("pankaj.jain@nineleaps.com", "Fitness", gymAddressClass, workoutList,
                                gymTime,
                                gymSubscriptionClass, l, 20);
                GymClass gymClass2 = new GymClass("GM1", "pankaj.jain@nineleaps.com", "Fitness", workoutList, 12345L,
                                null, 20);
        ...
        void testGetGymByCity() {
                ...
                Optional<GymSubscriptionClass> optional4 = Optional
                                .of(new GymSubscriptionClass("GM1", 1, 1, 1, 1, 1, 1));
                List<GymAddressClass> list = new ArrayList<>();
                list.add(gymAddressClass);
                List<GymRepresentModel> list3 = new ArrayList<>();
                list3.add(gymRepresent);
        ...
        void testGetGymByCityAddressNull() {
                List<String> workoutList = new ArrayList<>();
                workoutList.add("zumba");
                long l = 1234;
        ...
        void testGetGymByCityNull() {
                ...
                gymAddressClasses.add(gymAddressClass);
                GymClass gymClass = new GymClass();
                GymRepresentModel gymRepresent = new GymRepresentModel();
                List<GymRepresentModel> list = new ArrayList<>();
                list.add(gymRepresent);
                Optional<GymClass> optional = Optional.empty();
                when(addGymRepository.findById(gymClass.getId())).thenReturn(optional);
        ...
        void testGetGymByGymId() {
                ...
                when(gymTimeRepo.findById(gymClass.getId())).thenReturn(optional3);
                when(gymSubscriptionRepo.findById(gymClass.getId())).thenReturn(optional4);
                GymRepresentModel gymRepresent2 = gymService.getGymByGymId(gymClass.getId());
                Assertions.assertEquals(gymRepresent, gymRepresent2);
        }

        @Test
        @DisplayName("Testing to fetch the gym from it's id when returned null")
        void testGetGymByGymIdNull() {
                GymRepresentModel gymRepresent = null;
                GymClass gymClass = new GymClass();
                Optional<GymClass> optional5 = Optional.empty();
                when(addGymRepository.findById(gymClass.getId())).thenReturn(optional5);
                GymRepresentModel gymRepresent1 = gymService.getGymByGymId(gymClass.getId());
                Assertions.assertEquals(gymRepresent, gymRepresent1);
        ...
        void testGymAddressNull() {
                ...
                when(gymSubscriptionRepo.findById(gymClass.getId())).thenReturn(optional8);
                GymRepresentModel gymRepresent2 = gymService.getGymByGymId(gymClass.getId());
                Assertions.assertEquals(gymRepresent.getId(), gymRepresent2.getId());
        ...
        void testGetGymByVendorEmailNull() {
                GymClass gymClass = new GymClass();
                GymRepresentModel gymRepresent = new GymRepresentModel();
                Optional<GymAddressClass> optional2 = Optional.empty();
