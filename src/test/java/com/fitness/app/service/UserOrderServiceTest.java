...
class UserOrderServiceTest {
    ...
    void testAllMyUser() {
        ...
        services.add("zumba");
        UserOrder userOrder = new UserOrder("id", "email", "gym", services, "subscription", "slot", 12345, "booked",
    ...
    void testBookedGym() {
        ...
        List<String> services = new ArrayList<>();
        services.add("zumba");
        UserOrder userOrder = new UserOrder("id", "email", "gym", services, "subscription", "slot", 12345, "Current",
                "Completed", "paymentId", "receipt", localDate, localTime);
        List<Integer> attendance = new ArrayList<>();
        attendance.add(3);
        List<UserOrder> list = new ArrayList<>();
        ...
        GymRepresentModel gymRepresnt = new GymRepresentModel("id", "email", "gymName", gymAddressClass, workoutList, gymTime,
    ...
    void testBookedGymCurrent() {
        ...
        List<String> services = new ArrayList<>();
        services.add("zumba");
        UserOrder userOrder = new UserOrder("id", "email", "gym", services, "subscription", "slot", 12345, "Expired",
                "Completed", "paymentId", "receipt", localDate, localTime);
        List<Integer> attendance = new ArrayList<>();
        attendance.add(3);
        List<UserOrder> list = new ArrayList<>();
    ...
    void testCanOrder() {
        ...
        List<String> services = new ArrayList<>();
        services.add("zumba");
        userOrder = new UserOrder("id", "email", "gym", services, subscription, "slot", 12345, "Current", "Completed",
    ...
    void testCanOrderYearly() {
        ...
        List<String> services = new ArrayList<>();
        services.add("zumba");
        userOrder = new UserOrder("id", "email", "gym", services, "Yearly", "slot", 12345, "Current", "Completed",
                "paymentId", "receipt", localDate, localTime);
        List<Integer> attendance = new ArrayList<>();
        attendance.add(3);
        List<UserOrder> list = new ArrayList<>();
    ...
    void testUpdateOrderQuaterly() {
        ...
        List<String> services = new ArrayList<>();
        services.add("zumba");
        userOrder = new UserOrder("id", "email", "gym", services, subscription2, "slot", 12345, "Current", "status",
                "paymentId", "receipt", localDate, localTime);
        Optional<UserOrder> optional = Optional.of(new UserOrder("id", "email", "gym", services, subscription2, "slot",
    ...
    void testUpdateOrderHalfYearly() {
        ...
        userOrder.setReceipt("receipt");
        userOrder.setTime(localTime);
        Optional<UserOrder> optional = Optional.of(new UserOrder("id", "email", "gym", services, "half", "slot", 12345,
    ...
    void testUpdateOrderNone() {
        ...
        userOrder = new UserOrder("id", "email", "gym", services, "none", "slot", 12345, "Current", "status",
                "paymentId", "receipt", localDate, localTime);
        Optional<UserOrder> optional = Optional.of(new UserOrder("id", "email", "gym", services, "none", "slot", 12345,
                "Current", "Completed", "paymentId", "receipt", localDate, localTime));
        List<Integer> attendance = new ArrayList<>();
        attendance.add(3);
        List<UserOrder> list = new ArrayList<>();
    ...
    void testUpdateOrder() {
        ...
        userOrder = new UserOrder("id", "email", "gym", services, "monthly", "slot", 12345, "Current", "status",
                "paymentId", "receipt", localDate, localTime);
        Optional<UserOrder> optional = Optional.of(new UserOrder("id", "email", "gym", services, "monthly", "slot",
                12345, "Current", "Completed", "paymentId", "receipt", localDate, localTime));
        List<Integer> attendance = new ArrayList<>();
        attendance.add(3);
        List<UserOrder> list = new ArrayList<>();
